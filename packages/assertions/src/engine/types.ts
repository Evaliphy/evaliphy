...
export interface TextAssertions {
  ...
  /**
   * Asserts that the response contains the specified string.
   */
...
export interface DeterministicAssertionResult {
  passed: boolean;
  score: 0 | 1;
  reason: string;        // Generated by the assertion (e.g., diff or failure message)
  message?: string;      // Optional custom message provided by the user
